        ...
        <div class="col-md-4 m-auto">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ url('portfolio/edit') }}/{{ $portfolio_info->id }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>Short Text</label>
                            <input type="text" class="form-control" name="short_text" value="{{ $portfolio_info->short_text }}">
                            @error('short_text')
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{ asset('uploads/portfolio_photos') }}/{{ $portfolio_info->portfolio_photo }}" alt="not found" height="150" width="250">
                        </div>
